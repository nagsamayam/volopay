    ...
    <div class="sm">
        <section class="section">
            <div class="primary-banner">
                <div class="container">
                    <div class="intro">
                        <h1 class="h3 ff-2 semi-bold"><strong>No more</strong><div class="rw-words"><span class="medium">tedious Paperwork.</span> <span class="medium">Stacks of receipts.</span> <span class="medium">Reimbursements.</span></div></h1>
                        <p class="desc-3 sbt-1">AI-based payment card solution that does your expense reports and simplifies business spending.</p><a href="https://volopay.typeform.com/to/b2uP5J" target="_blank" class="btn rounded floating-btn">Free Trial</a>
                    </div>
                </div>
            </div>
        ...
        <section class="section">
            <div class="container">
                <h2 class="h3 ff-2 semi-bold center">The most efficient way to manage expenses</h2>
                <div class="row st-4">
                    <div id="waysCarousel" class="carousel carousel-slider center">
                        <div class="carousel-item" href="#way1!">
                            <div class="col sm-12 center">
                                <img src="images/payment-cards-for-employees.png" alt="way1" height="144">
                                <h3 class="h5 ff-2 semi-bold sbt-2 mw-0">Payment cards for employees</h3>
                                <p class="desc-2 mw-0">AI-powered cards for employees- Distribute virtual or plastic Volopay cards with custom predefined limits in just a few clicks.</p>
                            </div>
                        </div>
                        <div class="carousel-item" href="#way2!">
                            <div class="col sm-12 center">
                                <img src="images/automated-expense-reports.png" alt="way2" height="144">
                                <h3 class="h5 ff-2 semi-bold sbt-2 mw-0">Automated expense reports</h3>
                                <p class="desc-2 mw-0">Automated expense reports – Real-time notifications remind employees to take an image of the receipt on the go.</p>
                            </div>
                        </div>
                        <div class="carousel-item" href="#way3!">
                            <div class="col sm-12 center">
                                <img src="images/real-time-spending-overview.png" alt="way3" height="144">
                                <h3 class="h5 ff-2 semi-bold sbt-2 mw-0">Real-time spending overview</h3>
                                <p class="desc-2 mw-0">Real-time spending overview- See all company spending in one place as it happens and sync it to your accounting system.</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="section">
            <div class="container grid-10">
                <h2 class="h3 ff-2 semi-bold semi-bold center">Volopay solutions</h2>
                <div id="solutions" class="tabs-wrapper center">
                    <ul id="mTabs" class="tabs i-block">
                        <li class="tab"><a class="active" href="#prepaidCards"><i class="thumbnail t36x36 sol prepaid-cards">&nbsp;</i> <span class="i-block media-middle bold">Prepaid Cards</span></a>
                        </li>
                        <li class="tab"><a href="#automatedExpense"><i class="thumbnail t36x36 sol automated-expense">&nbsp;</i> <span class="i-block media-middle bold">Automated Expense</span></a>
                        </li>
                        <li class="tab"><a href="#travelExpense"><i class="thumbnail t36x36 sol travel-expense">&nbsp;</i> <span class="i-block media-middle bold">Travel Expense</span></a>
                        </li>
                        <li class="tab"><a href="#pettyCash"><i class="thumbnail t36x36 sol petty-cash">&nbsp;</i> <span class="i-block media-middle bold">Petty cash</span></a>
                        </li>
                    </ul><a class="btn btn-sm btn-default rounded-sm clickable"><span class="upper-case media-middle">LEARN MORE</span> <i class="material-icons media-middle md-18">&#xE5CC;</i></a>
                    <div id="prepaidCards" class="center">
                        <figure>
                            <img src="images/m-system.png" alt="prepaid-cards" class="responsive-img imgx110">
                        </figure>
                        <h3 class="h6 ff-2 semi-bold sb-2">Don't loose a receipt ever again</h3>
                        <p class="desc-2 sb-2">Employees can easily swipe the cards for expenses and get notified to snap a picture of the receipt immediately. All the expenses get automatically recorded and categorized without any delay.</p><a href="prepaid-cards.html" class="triggered">&nbsp;</a>
                    </div>
                    <div id="automatedExpense" class="center">
                        <figure>
                            <img src="images/automated-expense.png" alt="Automated Expense" class="responsive-img imgx110">
                        </figure>
                        <h3 class="h6 ff-2 semi-bold sb-2">Gain full control over all the expenses of your employees</h3>
                        <p class="desc-2 sb-2">Track all the expenses in real-time to avoid any surprises. Speed up the submission process for your employees by using technology like OCR and geo-locations. Our system learns from exceptions to predict outliers and prevent fraud.</p><a href="exepense-management.html" class="triggered">&nbsp;</a>
                    </div>
                    <div id="travelExpense" class="center">
                        <figure>
                            <img src="images/travel.png" alt="Travel Expense" class="responsive-img imgx110">
                        </figure>
                        <h3 class="h6 ff-2 semi-bold sb-2">Report and submit expenses the smart way</h3>
                        <p class="desc-2 sb-2">Provide your employees with prepaid travel cards and enable them to upload receipts on the go. You can also configure policy expense rules that warn or prevent submission unless all relevant information is completed.</p><a href="travel-expense.html" class="triggered">&nbsp;</a>
                    </div>
                    <div id="pettyCash" class="center">
                        <figure>
                            <img src="images/petty-cash.png" alt="Petty cash" class="responsive-img imgx110">
                        </figure>
                        <h3 class="h6 ff-2 semi-bold sb-2">Stop worrying about Petty cash</h3>
                        <p class="desc-2 sb-2">Monitor department/branch wise cash balances and expenses in real time. Customizable settings allow you to set daily, weekly or monthly budgets by category, team or any other settings and also allows you to distribute petty cash to them digitally with one click.</p><a href="petty-cash.html" class="triggered">&nbsp;</a>
                    </div>
                </div>
            </div>
        </section>
        <section class="section no-padding">
            <div class="bg light">
                <div class="container grid-10">
                    <h2 class="h3 ff-2 semi-bold center">Simple Setup</h2>
                    <div class="st-4">
                        <ul class="collapsible" data-collapsible="accordion">
                            <li>
                                <div class="collapsible-header"><span class="circle h5 nos i-block media-middle">1</span>
                                    <h3 class="h6 ff-2 semi-bold i-block media-middle">Add funds</h3>
                                </div>
                            ...
                            <li>
                                <div class="collapsible-header"><span class="circle h5 nos i-block media-middle">2</span>
                                    <h3 class="h6 ff-2 semi-bold i-block media-middle">Define your spending policy</h3>
                                </div>
                                <div class="collapsible-body">
                                    <p class="desc-2">Invite your team and set up the approval workflow that fits your specific needs. You get to decide the limits and approval flows for all kind of expenses.</p>
                                </div>
                            ...
                            <li>
                                <div class="collapsible-header"><span class="circle h5 nos i-block media-middle">3</span>
                                    <h3 class="h6 ff-2 semi-bold i-block media-middle">Your teams can start paying!</h3>
                                </div>
                                <div class="collapsible-body">
                                    <p class="desc-2">Teammates can now use Volopay cards to pay for their expenses and save their invoices. All payments will instantly appear in your dashboard in real-time!</p>
                                </div>
        ...
        <section class="section no-padding">
            <div class="bg blogs">
                <div class="container grid-10">
                    <h2 class="h3 ff-2 semi-bold semi-bold center">BLOGS</h2>
                    <div class="row st-4">
                        <div class="col sm-12"><span class="box"><a href="http://wpblog.volopay.co/?p=168" target="_blank" title="Artificial Intelligence and you" style="background-image:url(images/artificial-intelligence.jpg)" class="thumbnail tfullx160"></a></span>
                            <h4 class="h5 ff-2 semi-bold sbt-4"><a href="http://wpblog.volopay.co/?p=168" target="_blank" title="Artificial Intelligence and you">Artificial Intelligence and you</a></h4>
                            <p>Upon hearing the words "Artificial Intelligence" most of us instantly assume some sort of an inhuman power dominating us all...</p>
                            <div class="media">
                                <div class="media-left media-middle">
                                    <a href="http://wpblog.volopay.co/?p=168" target="_blank" class="circle t36x36">
                                        <img src="images/brand-square.png" alt="Volopay" class="circle responsive-img">
                        ...
                        <div class="col sm-12 st-4"><span class="box"><a href="http://wpblog.volopay.co/?p=187" target="_blank" title="Don't make those expense reports ever again!" style="background-image:url(images/expense-reports.jpg)" class="thumbnail tfullx160"></a></span>
                            <h4 class="h5 ff-2 semi-bold sbt-4"><a href="http://wpblog.volopay.co/?p=187" target="_blank" title="Don't make those expense reports ever again!">Don't make those expense reports ever again!</a></h4>
                            <p>Business trips are fun for most of the part--you get to grow your business, meet new people, face new challenges and lot more...</p>
                            <div class="media">
                                <div class="media-left media-middle">
                                    <a href="http://wpblog.volopay.co/?p=187" target="_blank" class="t36x36">
                                        <img src="images/brand-square.png" alt="Volopay" class="circle responsive-img">
